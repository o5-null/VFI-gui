"""Model management panel widget for VFI-gui.

A sidebar panel for viewing and managing VFI models.
"""
...
class ModelPanel(QWidget):
    ...
    def __init__(
        ...
        # Create ModelManager using global config
    ...
    def _setup_ui(self):
        ...
        self.summary_label.setStyleSheet("color: #808080; font-size: 9pt;")
        ...
        self.progress_label.setStyleSheet("color: #808080; font-size: 9pt;")
    ...
    def refresh(self):
        ...
        for model_type, type_info in sorted(models.items()):
            ...
            type_item.setExpanded(type_info.installed_count > 0)
