...
from .config import get_models_dir, get_engine_cache_dir
import os
...
def scene_detect(
    ...
    onnx_path = os.path.join(get_models_dir(), onnx_path)
    check_and_download(onnx_path)

    # https://onnxruntime.ai/docs/execution-providers/TensorRT-Execution-Provider.html
    options = {}
    options["device_id"] = 0
    ...
    options["trt_engine_cache_path"] = get_engine_cache_dir()
