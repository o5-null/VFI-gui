...
from core.events import engines_updated, models_updated
...
class ModelTypeInfo:
    ...
    display_name: str
    description: str = ""
    info: str = ""  # Short feature summary for UI display
    sort_order: int = 999  # Lower = more recommended (displayed first)
...
# sort_order: Lower = more recommended (displayed first)
# info: Short feature summary for UI display
MODEL_DEFINITIONS: Dict[str, Dict] = {
    "rife": {
        "display_name": "RIFE",
        "description": "Real-Time Intermediate Flow Estimation for Video Frame Interpolation",
        "info": "推荐 | 质量速度平衡最佳",
        "sort_order": 1,  # Most recommended - best quality/speed balance
        "checkpoints": {
            "rife47.pth": [
    ...
    "film": {
        ...
        "info": "大运动场景 | 电影级效果",
        "sort_order": 2,  # Good for large motion scenes
        "checkpoints": {
            "film_net_fp32.pt": [
    ...
    "atm": {
        ...
        "info": "Transformer架构",
        "sort_order": 11,  # Transformer-based
        "checkpoints": {
            "atm-vfi-base.pt": [
    ...
    "xvfi": {
        ...
        "info": "极端运动 | 高动态场景",
        "sort_order": 15,  # For extreme motion
        "checkpoints": {
            "xvfi.pth": [
...
class ModelManager:
    ...
    Events:
        engines_updated: Emitted when TensorRT engines are rescanned
        models_updated: Emitted when model checkpoints are rescanned
    """
