...
class ModelManager:
    ...
    def __init__(
        ...
        self._model_cache: Dict[Tuple, VFIModelBase] = {}
        
        # Registry of available model types
        self._model_registry: Dict[str, Type[VFIModelBase]] = {}
        
        # Ensure models directory exists
        self.models_dir.mkdir(parents=True, exist_ok=True)
    
    def register_model_type(self, model_type: str, model_class: Type[VFIModelBase]) -> None:
